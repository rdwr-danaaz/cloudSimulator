"""Helper: writes cloud_mock_server.py to disk."""
...
pathlib.Path("cloud_mock_server.py").write_text(SERVER, encoding="utf-8")
print(f"Written {len(SERVER)} chars to cloud_mock_server.py")
